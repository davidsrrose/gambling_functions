#generates a global vector of bankroll change over bets made
...
ev_bankroll_vector_generator <- function(bets=1000,bankroll_start = 1000,kelly_multiplier=1){
  
  
  #initialize variables
  #bankroll vector
  ev_bankroll_vector <<- rep(0,bets)
  #bankroll dataframe 
  colnames(ev_bankroll_vector) <<- c("bankroll_total")
  
  #set bankroll at first bet
  ev_bankroll_vector[1] <<- bankroll_start
  
  #loop through all bets and fill bankroll vector
