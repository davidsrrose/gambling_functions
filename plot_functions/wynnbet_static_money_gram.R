...
# none
#-------------------------------------------------------------------------------
wynnbet_static_money_gram <- function(n = 10000,
                                      strategy = "static0") {
  ...
  distribution_plot <- ggplot(
    ...
    ggtitle(
      paste(
        "Wynnbet Promo Distribution of Expected Profit \nStrategy:",
        strategy
      )
    ) +
    ...
    geom_segment(
      aes(
        ...
        y = 0,
        xend = average_profit,
        yend = e_profit_bar_label_probablity - y_axis_max / 100
      ),
      linetype = "dashed",
      col = "darkgreen",
      size = .8,
    ...
    geom_segment(
      aes(
        x = average_profit,
        y = e_profit_bar_label_probablity + y_axis_max / 12,
        xend = average_profit,
        yend = Inf
      ), # ...
      linetype = "dashed",
    ...
    geom_text(
      ...
      vjust = -0.35,
      hjust = profit_df$bar_label_justification,
      size = 4
    ) +
