...
#------------------------------------------------------------------------------------------------------------------------------------------------
bonus_bets_profit <- function(total_bonus_bets=100,bonus_bets_bet = 100,bonus_odds = 400,bonus_stake=20){
  
  #error message if we try to bet more than the total number of bets we have
  if (total_bonus_bets  < bonus_bets_bet){
    #warning message to user
    print("Error in function bonus_bets_profit, bonus_bets cannot be larger than total_bets")
    #exit function
    stop()
  }
